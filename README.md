...
- **阴阳配合**：输入任意法语词（代词、形容词、名词、冠词等），列出该词全部阴阳单复形态，每个形态附本地例句
- **动词分组**：按词尾与词族分类记忆不规则动词（-dre/-ttre/-tir/-enir/-indre/-uire/-aître/-oir 等规律族）
- **句子分析**：逐词解析句子的词性、时态、语法成分
- **语法练习**：时态、词汇、介词、连词、副词、代词六大题库测验
- **代词表**：常用法语代词速查
- **收藏夹**：AI 收藏 / 单词 / 句子 / 视频转文字四类分栏展示，支持朗读、复制、多选播放与移除
- **悬浮窗**：透明自适应小窗播报单词与例句，可拖动（像素级精确跟手）、锁定位置、暂停播放、语速/字号调节；收藏词循环播放可揭示并朗读中文释义（仅含中文的释义朗读）
