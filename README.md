...
- **AI 批量导入收藏**：查词界面搜索框旁的「导入」按钮进入导入页，粘贴任意法语内容（单词 / 短语 / 一段文本），AI 识别出词性、音标、中文释义、例句与中文例句，可逐条修正后一次性导入「收藏-单词」，与收藏词一样支持选择与播放
...
- **代词表**：常用法语代词速查
- **收藏夹**：AI 收藏 / 单词 / 句子 / 视频转文字四类分栏展示，支持朗读、复制、多选播放与移除；「收藏-单词」多选后可一键「整理」：AI 把所选词（含英文杂义、速记）统一改写为「词性+中文义+音标+例句」标准格式并写回（AI 未给出中文义的词保留原义）
...
- 直接下载 [最新 Release](https://github.com/coolmoonboom/moonfrenchdict/releases/latest) 中的 APK 安装（当前 v1.0.48）
- 或按上方步骤本地构建后安装
